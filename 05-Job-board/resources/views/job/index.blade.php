            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <x-text-input type="number" name="min_salary" value="{{ request('min_salary') }}" placeholder="From"/>
                        <x-text-input type="number" name="max_salary" value="{{ request('max_salary') }}" placeholder="To"/>
                    </div>
                </div>
                <div>
